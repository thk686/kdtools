...
test_that("handles circular tie breaking", {
  ...
  expect_equal(kd_sort(cbind_mat(0, x)), cbind_mat(0, sort(x)))
  expect_equal(kd_sort(cbind_mat(0, 1, x)), cbind_mat(0, 1, sort(x)))
  expect_equal(kd_sort(cbind_mat(0, 1, 2, x)), cbind_mat(0, 1, 2, sort(x)))
  expect_equal(kd_sort(cbind_mat(0, x, 1)), cbind_mat(0, sort(x), 1))
})
