...
Note: In recent versions of kdtools, this behavior is controlled at compile time by defining USE_CIRCULAR_LEXICOGRAPHIC_COMPARE, which is not defined by default, so results in this section may be misleading.
